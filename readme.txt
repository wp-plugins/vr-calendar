...
An availability calendar for vacation rentals driven via the iCal standard from any calendar that exports iCal format (HomeAway, VRBO, Flipkey, AirBnB, Google, Apple iCloud, and more). 
...
using the [vrcalendar] shortcode. You can specify a size like [vrcalendar size=large] where size can be small, medium, or large.
